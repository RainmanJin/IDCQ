...
import controller.JinHD_AddListener;
import dao.Dao;

import org.eclipse.wb.swt.SWTResourceManager;

public class JinHD_Add extends Dialog {
	...
	String name = null;
	String spname = null;
	JinHD_AddListener jdl;
	JinHD jh;

	public JinHD_Add(Shell parent, int style) {
		super(parent, style);
	}

	public JinHD_Add(Shell parent) {
		this(parent, SWT.NONE);
	}

	public Object open(String name,JinHD jh) {
		this.name = name;
		this.jh = jh;
		createContents();
		shell.open();
		...
		jdl = new JinHD_AddListener(name, JinHD_Add.this);
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(JinHD_Add.class, "/picture/6.jpg"));
