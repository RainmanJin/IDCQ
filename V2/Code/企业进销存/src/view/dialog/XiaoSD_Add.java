...
import controller.XiaoSD_AddListener;
import dao.Dao;

import org.eclipse.wb.swt.SWTResourceManager;

public class XiaoSD_Add extends Dialog {
	...
	String name = null;
	String spname = null;
	XiaoSD_AddListener xdl;
	XiaoSD xs;

	public XiaoSD_Add(Shell parent, int style) {
		super(parent, style);
	}

	public XiaoSD_Add(Shell parent) {
		this(parent, SWT.NONE);
	}

	public Object open(String name,XiaoSD xs) {
		this.name = name;
		this.xs = xs;
		createContents();
		shell.open();
		...
		xdl = new XiaoSD_AddListener(name, XiaoSD_Add.this);
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(XiaoSD_Add.class, "/picture/6.jpg"));
