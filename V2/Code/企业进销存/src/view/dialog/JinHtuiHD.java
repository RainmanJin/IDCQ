...
public class JinHtuiHD extends Dialog {
	...
	public JinHtuiHD(Shell parent, int style) {
		super(parent, style);
	}

	public JinHtuiHD(Shell parent) {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(JinHtuiHD.class, "/picture/6.jpg"));
		shell.setSize(716, 539);
		...
		text_2.setBounds(580, 17, 110, 26);

		text_3 = new Text(shell, SWT.BORDER);
		text_3.setBounds(580, 57, 110, 26);
		...
		text_7.setBounds(580, 407, 110, 26);
		...
		table.setBounds(30, 100, 660, 300);
		...
		button.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				...
				new JinHtuiHD_Add(Display.getCurrent().getActiveShell()).open(name,JinHtuiHD.this);
				int sl = 0;
				double menoy = 0.0;
		...
		button_1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				TbRkthMain rkthMain = new TbRkthMain(
						text.getText().trim(), 
						text_5.getText().trim(), 
						text_7.getText().trim(), 
						text_8.getText().trim(),
				...
				if(rs) {
					MessageDialog.openInformation(shell, "提示", "退货成功!");
					table.removeAll();
					text_3.setText("");
					text_8.setText("");
				}
		...
		button_1.setText("退货");
		button_1.setBounds(630, 447, 48, 26);
	...
	public void initTime() {
		...
		String maxId = Dao.getRkthMainMaxId(de);
		text.setText(maxId);
	}
