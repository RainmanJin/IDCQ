...
import controller.JinHtuiHD_AddListener;
import dao.Dao;

import org.eclipse.wb.swt.SWTResourceManager;

public class JinHtuiHD_Add extends Dialog {
	...
	String name = null;
	String spname = null;
	JinHtuiHD_AddListener jdl;
	JinHtuiHD jh;

	public JinHtuiHD_Add(Shell parent, int style) {
		super(parent, style);
	}

	public JinHtuiHD_Add(Shell parent) {
		this(parent, SWT.NONE);
	}

	public Object open(String name,JinHtuiHD jh) {
		this.name = name;
		this.jh = jh;
		createContents();
		shell.open();
		...
		jdl = new JinHtuiHD_AddListener(name, JinHtuiHD_Add.this);
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(JinHtuiHD_Add.class, "/picture/6.jpg"));
		...
		label_1_1.setBounds(30, 100, 48, 24);
		label_1_1.setText("单    价");

		text_2 = new Text(shell, SWT.BORDER);
		text_2.setBounds(110, 97, 200, 26);
	}
