...
public class XiaoStuiHD extends Dialog {
	...
	public XiaoStuiHD(Shell parent, int style) {
		super(parent, style);
	}

	public XiaoStuiHD(Shell parent) {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(XiaoStuiHD.class, "/picture/6.jpg"));
		...
		text_8.setBounds(110, 450, 130, 26);

		text_9 = new Text(shell, SWT.READ_ONLY | SWT.BORDER);
		text_9.setBounds(332, 447, 160, 26);
		...
		button.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				...
				new XiaoStuiHD_Add(Display.getCurrent().getActiveShell()).open(name,XiaoStuiHD.this);
				int sl = 0;
				double menoy = 0.0;
		...
		button_1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				TbXsthMain xsthMain = new TbXsthMain(
						text.getText().trim(), 
						text_5.getText().trim(), 
						text_7.getText().trim(), 
						text_8.getText().trim(),
	...
	public void initTime() {
		...
		String maxId = Dao.getXsthMainMaxId(de);
		text.setText(maxId);
	}
