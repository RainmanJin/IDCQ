...
import controller.XiaoStuiHCXListener;
import org.eclipse.wb.swt.SWTResourceManager;

public class XiaoStuiHCX extends Dialog {
	...
	public XiaoStuiHCX(Shell parent, int style) {
		super(parent, style);
	}

	public XiaoStuiHCX(Shell parent) {
	...
	protected void createContents() {
		...
		newColumnTableColumn.setText("销售退货票号");
		...
		newColumnTableColumn_8.setText("退货日期");
		...
		new XiaoStuiHCXListener(XiaoStuiHCX.this);
	}
