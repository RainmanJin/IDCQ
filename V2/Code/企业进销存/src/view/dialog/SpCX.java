...
import controller.SpCXListener;
import org.eclipse.wb.swt.SWTResourceManager;

public class SpCX extends Dialog {
	...
	public SpCX(Shell parent, int style) {
		super(parent, style);
	}

	public SpCX(Shell parent) {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(SpCX.class, "/picture/6.jpg"));
	...
	public void setNewItemTableItem(TableItem newItemTableItem) {
