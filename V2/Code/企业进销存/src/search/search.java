...
//		System.out.println("请输入待查询的语句：" + System.getProperty("user.dir"));
//		BufferedReader buf = new BufferedReader(new InputStreamReader(System.in));
//		String string = buf.readLine();
//		check_time(string);
//		ci = get_ci(string);
//		Printshuzu(ci);
////		String path = "F:/java项目/Project/src/dictionary/dict.txt";
...
//	}
	...
	public String run(String yuju) throws Exception {
		this.yuju = yuju;
		check_time(this.yuju);
		ci = get_ci(this.yuju);
		Printshuzu(ci);
		String path = "src/dictionary/dict.txt";
		// String path = "F:\\eclipse存储\\企业进销存管理系统\\get_cixing _1.txt";
		ensure_cixing(path);
		// Printshuzu(ci); Printshuzu(cixing1); Printshuzu(cixing2);
		// Printshuzu(cixing3);
		String sql = makeSQL(ci, cixing1, cixing2, cixing3);
		System.out.println(sql);
		return sql;
